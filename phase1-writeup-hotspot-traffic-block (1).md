...
## Key Takeaways
- This is a **Layer 2 attack**. The attacker and target must share the same broadcast domain (same WiFi/LAN). It doesn't work across separate networks.
